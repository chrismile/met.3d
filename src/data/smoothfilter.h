...
protected:
    ...
    /**
     * @brief boxBlurLongitudinalFast Longitudinal box blur implemented with a
    ...
    /**
     * @brief boxBlurLatitudinalFast Latitudinal box blur implemented with a
     ...
     */
    void boxBlurLatitudinalFast(const MStructuredGrid *inputGrid,
