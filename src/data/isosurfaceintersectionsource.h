...
namespace Met3D
{
    ...
    private:
        /** @var lines
            @brief Stores the list of lines
        ...
        */
        ...
        /** @var inputSourceB
            @brief The input source for the second variable.
        */
        //MWeatherPredictionDataSource* inputSourceB;
        ...
        /** @var currentSegmentFace
            @brief Stores the face that the last added segment ends in.
            Is used in the tracing method.
        */
        ...
        */
        ...
        /** @var faceTable
            @brief Faces table describes the relation betweed corner points cutten faces

            The following table descibes which faces can have an intersection
            depending on which of the 8 corner points of the cube is under the regarding
            isolevel.
        ...
        */
        ...
        /** @var facePoints
            @brief This array stores the Relation between face of a cube and the corner points.

            This array describes which are the points
            of each face in the cube.
        ...
        */
        ...
        /** @var edgePoints
            @brief This array sores the relation between the faces and the face edges.

            In the following we abbreviate the eight cornerpoints of the
            current cell with p[0..7] and the corresponding values with
            v[0..7].

            This array describes which are the edges
            of each face in the cube.
        ...
        */
        ...
        /** @var edgeTable
            ...
            This array describes which combination of corner points
            that are under the isovalue results into which edges get cut.
        */
        ...
        struct CellInformation
        {
            ...
            */
            ...
            /** @enum faces1
                @brief The cutten faces of variable 1.
            */
            int faces1;
            /** @enum faces2
                @brief The cutten faces of variable 2.
            */
            int faces2;
            /** @enum index
            ...
            */
            ...
            bool isEmpty = false;
            /** @enum segments
                @brief The found cell segments in the cell.
            */
            QVector<QVector<QVector3D> *> segments;
            /** @enum pointFaceRelation
                @brief Describes to which faces one point of the segments belong to.
            */
            ...
            */
            ...
            /**
                ...
                The cubeindex describes which values of the cube are below the isovalue.
                It stores this by switching on/off bytes in an integer value.
            */
        ...
        private:
            ...
            /**
                @brief Fills this cells corner points with the correct positions.
            */
            ...
            /**
                @brief Fills this cells corner points with the correct values.
        ...
        /**
            @var computedCells
            @brief Stores the CellInformations that are already go calculated.
        ...
        */
        ...
        /**
            ...
            The params @valp1 and @valp2 are the values of the grid at the points
            p1 and p2. The param @isolevel is the value that represents the value
        ...
        */
        ...
        /**
            ...
            Is uesd to decide weather to close a cell or not.
        */
        ...
        */
        ...
        /**
            @brief Computes the next cell by use of the startingCell and the instance variable currentSegmentFace.
        */
        CellInformation *getNextCell(
        ...
        static inline QVector3D
        flatIndexToVector3D(int i, MStructuredGrid *grid)
        {
        ...
        static inline bool
        cellIsOutOfBounds(int actCellIndex, MStructuredGrid *grid)
        {
        ...
        static inline int
        Vector3DtoFlatIndex(const QVector3D &vector, MStructuredGrid *grid)
        {
